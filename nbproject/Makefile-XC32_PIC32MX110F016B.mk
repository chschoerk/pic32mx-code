...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-XC32_PIC32MX110F016B.mk dist/${CND_CONF}/${IMAGE_TYPE}/RxModuleCode03_packet02_I2Ctest.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/adf7023_mint.o: adf7023_mint.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/adf7023_mint.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/adf7023_mint.o.d" -o ${OBJECTDIR}/adf7023_mint.o adf7023_mint.c   
	
${OBJECTDIR}/configandmux.o: configandmux.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/configandmux.o.d 
	@${FIXDEPS} "${OBJECTDIR}/configandmux.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/configandmux.o.d" -o ${OBJECTDIR}/configandmux.o configandmux.c   
	
${OBJECTDIR}/si5326.o: si5326.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/si5326.o.d 
	@${FIXDEPS} "${OBJECTDIR}/si5326.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/si5326.o.d" -o ${OBJECTDIR}/si5326.o si5326.c   
	
${OBJECTDIR}/timestamping.o: timestamping.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/timestamping.o.d 
	@${FIXDEPS} "${OBJECTDIR}/timestamping.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/timestamping.o.d" -o ${OBJECTDIR}/timestamping.o timestamping.c   
	
${OBJECTDIR}/switching.o: switching.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/switching.o.d 
	@${FIXDEPS} "${OBJECTDIR}/switching.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/switching.o.d" -o ${OBJECTDIR}/switching.o switching.c   
...
${OBJECTDIR}/_TxModuleMain.o: _TxModuleMain.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_TxModuleMain.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_TxModuleMain.o.d" -o ${OBJECTDIR}/_TxModuleMain.o _TxModuleMain.c   
	
${OBJECTDIR}/measuring.o: measuring.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/measuring.o.d 
	@${FIXDEPS} "${OBJECTDIR}/measuring.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/measuring.o.d" -o ${OBJECTDIR}/measuring.o measuring.c   
	
${OBJECTDIR}/smbus.o: smbus.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/smbus.o.d 
	@${FIXDEPS} "${OBJECTDIR}/smbus.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/smbus.o.d" -o ${OBJECTDIR}/smbus.o smbus.c   
	
${OBJECTDIR}/pwm_vcxo.o: pwm_vcxo.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/pwm_vcxo.o.d 
	@${FIXDEPS} "${OBJECTDIR}/pwm_vcxo.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/pwm_vcxo.o.d" -o ${OBJECTDIR}/pwm_vcxo.o pwm_vcxo.c   
...
dist/${CND_CONF}/${IMAGE_TYPE}/RxModuleCode03_packet02_I2Ctest.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)    -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/RxModuleCode03_packet02_I2Ctest.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1
